        ...
        struct d3d12_device *device)
{
    ...
    vk_prepend_struct(&info->properties2, &info->vulkan12_properties);
...
static void vkd3d_physical_device_info_init(struct vkd3d_physical_device_info *info, struct d3d12_device *device)
{
    ...
    info->vulkan12_properties.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_2_PROPERTIES;
        ...
        uint32_t *device_extension_count, bool **user_extension_supported)
{
    ...
    /* HACK: MoltenVK's descriptor indexing is currently too broken for us to use */
    if (physical_device_info->vulkan12_properties.driverID == VK_DRIVER_ID_MOLTENVK)
