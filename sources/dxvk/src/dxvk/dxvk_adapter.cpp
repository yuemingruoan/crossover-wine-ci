...
namespace dxvk {
  ...
  static bool log_info_and_return_false(const char *message) {
    Logger::info(message);
    return false;
  }

  bool DxvkAdapter::checkFeatureSupport(const DxvkDeviceFeatures& required) const {
#define REPORT(x) log_info_and_return_false("Missing feature: " #x)
    return (m_deviceFeatures.core.features.robustBufferAccess
                || !required.core.features.robustBufferAccess || REPORT(robustBufferAccess))
        && (m_deviceFeatures.core.features.fullDrawIndexUint32
                || !required.core.features.fullDrawIndexUint32 || REPORT(fullDrawIndexUint32))
        && (m_deviceFeatures.core.features.imageCubeArray
                || !required.core.features.imageCubeArray || REPORT(imageCubeArray))
        && (m_deviceFeatures.core.features.independentBlend
                || !required.core.features.independentBlend || REPORT(independentBlend))
        && (m_deviceFeatures.core.features.geometryShader
                || !required.core.features.geometryShader || REPORT(geometryShader))
        && (m_deviceFeatures.core.features.tessellationShader
                || !required.core.features.tessellationShader || REPORT(tessellationShader))
        && (m_deviceFeatures.core.features.sampleRateShading
                || !required.core.features.sampleRateShading || REPORT(sampleRateShading))
        && (m_deviceFeatures.core.features.dualSrcBlend
                || !required.core.features.dualSrcBlend || REPORT(dualSrcBlend))
        && (m_deviceFeatures.core.features.logicOp
                || !required.core.features.logicOp || REPORT(logicOp))
        && (m_deviceFeatures.core.features.multiDrawIndirect
                || !required.core.features.multiDrawIndirect || REPORT(multiDrawIndirect))
        && (m_deviceFeatures.core.features.drawIndirectFirstInstance
                || !required.core.features.drawIndirectFirstInstance || REPORT(drawIndirectFirstInstance))
        && (m_deviceFeatures.core.features.depthClamp
                || !required.core.features.depthClamp || REPORT(depthClamp))
        && (m_deviceFeatures.core.features.depthBiasClamp
                || !required.core.features.depthBiasClamp || REPORT(depthBiasClamp))
        && (m_deviceFeatures.core.features.fillModeNonSolid
                || !required.core.features.fillModeNonSolid || REPORT(fillModeNonSolid))
        && (m_deviceFeatures.core.features.depthBounds
                || !required.core.features.depthBounds || REPORT(depthBounds))
        && (m_deviceFeatures.core.features.wideLines
                || !required.core.features.wideLines || REPORT(wideLines))
        && (m_deviceFeatures.core.features.largePoints
                || !required.core.features.largePoints || REPORT(largePoints))
        && (m_deviceFeatures.core.features.alphaToOne
                || !required.core.features.alphaToOne || REPORT(alphaToOne))
        && (m_deviceFeatures.core.features.multiViewport
                || !required.core.features.multiViewport || REPORT(multiViewport))
        && (m_deviceFeatures.core.features.samplerAnisotropy
                || !required.core.features.samplerAnisotropy || REPORT(samplerAnisotropy))
        && (m_deviceFeatures.core.features.textureCompressionETC2
                || !required.core.features.textureCompressionETC2 || REPORT(textureCompressionETC2))
        && (m_deviceFeatures.core.features.textureCompressionASTC_LDR
                || !required.core.features.textureCompressionASTC_LDR || REPORT(textureCompressionASTC_LDR))
        && (m_deviceFeatures.core.features.textureCompressionBC
                || !required.core.features.textureCompressionBC || REPORT(textureCompressionBC))
        && (m_deviceFeatures.core.features.occlusionQueryPrecise
                || !required.core.features.occlusionQueryPrecise || REPORT(occlusionQueryPrecise))
        && (m_deviceFeatures.core.features.pipelineStatisticsQuery
                || !required.core.features.pipelineStatisticsQuery || REPORT(pipelineStatisticsQuery))
        && (m_deviceFeatures.core.features.vertexPipelineStoresAndAtomics
                || !required.core.features.vertexPipelineStoresAndAtomics || REPORT(vertexPipelineStoresAndAtomics))
        && (m_deviceFeatures.core.features.fragmentStoresAndAtomics
                || !required.core.features.fragmentStoresAndAtomics || REPORT(fragmentStoresAndAtomics))
        && (m_deviceFeatures.core.features.shaderTessellationAndGeometryPointSize
                || !required.core.features.shaderTessellationAndGeometryPointSize || REPORT(shaderTessellationAndGeometryPointSize))
        && (m_deviceFeatures.core.features.shaderImageGatherExtended
                || !required.core.features.shaderImageGatherExtended || REPORT(shaderImageGatherExtended))
        && (m_deviceFeatures.core.features.shaderStorageImageExtendedFormats
                || !required.core.features.shaderStorageImageExtendedFormats || REPORT(shaderStorageImageExtendedFormats))
        && (m_deviceFeatures.core.features.shaderStorageImageMultisample
                || !required.core.features.shaderStorageImageMultisample || REPORT(shaderStorageImageMultisample))
        && (m_deviceFeatures.core.features.shaderStorageImageReadWithoutFormat
                || !required.core.features.shaderStorageImageReadWithoutFormat || REPORT(shaderStorageImageReadWithoutFormat))
        && (m_deviceFeatures.core.features.shaderStorageImageWriteWithoutFormat
                || !required.core.features.shaderStorageImageWriteWithoutFormat || REPORT(shaderStorageImageWriteWithoutFormat))
        && (m_deviceFeatures.core.features.shaderUniformBufferArrayDynamicIndexing
                || !required.core.features.shaderUniformBufferArrayDynamicIndexing || REPORT(shaderUniformBufferArrayDynamicIndexing))
        && (m_deviceFeatures.core.features.shaderSampledImageArrayDynamicIndexing
                || !required.core.features.shaderSampledImageArrayDynamicIndexing || REPORT(shaderSampledImageArrayDynamicIndexing))
        && (m_deviceFeatures.core.features.shaderStorageBufferArrayDynamicIndexing
                || !required.core.features.shaderStorageBufferArrayDynamicIndexing || REPORT(shaderStorageBufferArrayDynamicIndexing))
        && (m_deviceFeatures.core.features.shaderStorageImageArrayDynamicIndexing
                || !required.core.features.shaderStorageImageArrayDynamicIndexing || REPORT(shaderStorageImageArrayDynamicIndexing))
        && (m_deviceFeatures.core.features.shaderClipDistance
                || !required.core.features.shaderClipDistance || REPORT(shaderClipDistance))
        && (m_deviceFeatures.core.features.shaderCullDistance
                || !required.core.features.shaderCullDistance || REPORT(shaderCullDistance))
        && (m_deviceFeatures.core.features.shaderFloat64
                || !required.core.features.shaderFloat64 || REPORT(shaderFloat64))
        && (m_deviceFeatures.core.features.shaderInt64
                || !required.core.features.shaderInt64 || REPORT(shaderInt64))
        && (m_deviceFeatures.core.features.shaderInt16
                || !required.core.features.shaderInt16 || REPORT(shaderInt16))
        && (m_deviceFeatures.core.features.shaderResourceResidency
                || !required.core.features.shaderResourceResidency || REPORT(shaderResourceResidency))
        && (m_deviceFeatures.core.features.shaderResourceMinLod
                || !required.core.features.shaderResourceMinLod || REPORT(shaderResourceMinLod))
        && (m_deviceFeatures.core.features.sparseBinding
                || !required.core.features.sparseBinding || REPORT(sparseBinding))
        && (m_deviceFeatures.core.features.sparseResidencyBuffer
                || !required.core.features.sparseResidencyBuffer || REPORT(sparseResidencyBuffer))
        && (m_deviceFeatures.core.features.sparseResidencyImage2D
                || !required.core.features.sparseResidencyImage2D || REPORT(sparseResidencyImage2D))
        && (m_deviceFeatures.core.features.sparseResidencyImage3D
                || !required.core.features.sparseResidencyImage3D || REPORT(sparseResidencyImage3D))
        && (m_deviceFeatures.core.features.sparseResidency2Samples
                || !required.core.features.sparseResidency2Samples || REPORT(sparseResidency2Samples))
        && (m_deviceFeatures.core.features.sparseResidency4Samples
                || !required.core.features.sparseResidency4Samples || REPORT(sparseResidency4Samples))
        && (m_deviceFeatures.core.features.sparseResidency8Samples
                || !required.core.features.sparseResidency8Samples || REPORT(sparseResidency8Samples))
        && (m_deviceFeatures.core.features.sparseResidency16Samples
                || !required.core.features.sparseResidency16Samples || REPORT(sparseResidency16Samples))
        && (m_deviceFeatures.core.features.sparseResidencyAliased
                || !required.core.features.sparseResidencyAliased || REPORT(sparseResidencyAliased))
        && (m_deviceFeatures.core.features.variableMultisampleRate
                || !required.core.features.variableMultisampleRate || REPORT(variableMultisampleRate))
        && (m_deviceFeatures.core.features.inheritedQueries
                || !required.core.features.inheritedQueries || REPORT(inheritedQueries))
        && (m_deviceFeatures.shaderDrawParameters.shaderDrawParameters
                || !required.shaderDrawParameters.shaderDrawParameters || REPORT(shaderDrawParameters))
        && (m_deviceFeatures.ext4444Formats.formatA4R4G4B4
                || !required.ext4444Formats.formatA4R4G4B4 || REPORT(formatA4R4G4B4))
        && (m_deviceFeatures.ext4444Formats.formatA4B4G4R4
                || !required.ext4444Formats.formatA4B4G4R4 || REPORT(formatA4B4G4R4))
        && (m_deviceFeatures.extCustomBorderColor.customBorderColors
                || !required.extCustomBorderColor.customBorderColors || REPORT(customBorderColors))
        && (m_deviceFeatures.extCustomBorderColor.customBorderColorWithoutFormat
                || !required.extCustomBorderColor.customBorderColorWithoutFormat || REPORT(customBorderColorWithoutFormat))
        && (m_deviceFeatures.extDepthClipEnable.depthClipEnable
                || !required.extDepthClipEnable.depthClipEnable || REPORT(depthClipEnable))
        && (m_deviceFeatures.extExtendedDynamicState.extendedDynamicState
                || !required.extExtendedDynamicState.extendedDynamicState || REPORT(extendedDynamicState))
        && (m_deviceFeatures.extHostQueryReset.hostQueryReset
                || !required.extHostQueryReset.hostQueryReset || REPORT(hostQueryReset))
        && (m_deviceFeatures.extMemoryPriority.memoryPriority
                || !required.extMemoryPriority.memoryPriority || REPORT(memoryPriority))
        && (m_deviceFeatures.extNonSeamlessCubeMap.nonSeamlessCubeMap
                || !required.extNonSeamlessCubeMap.nonSeamlessCubeMap || REPORT(nonSeamlessCubeMap))
        && (m_deviceFeatures.extRobustness2.robustBufferAccess2
                || !required.extRobustness2.robustBufferAccess2 || REPORT(robustBufferAccess2))
        && (m_deviceFeatures.extRobustness2.robustImageAccess2
                || !required.extRobustness2.robustImageAccess2 || REPORT(robustImageAccess2))
        && (m_deviceFeatures.extRobustness2.nullDescriptor
                || !required.extRobustness2.nullDescriptor || REPORT(nullDescriptor))
        && (m_deviceFeatures.extTransformFeedback.transformFeedback
                || !required.extTransformFeedback.transformFeedback || REPORT(transformFeedback))
        && (m_deviceFeatures.extVertexAttributeDivisor.vertexAttributeInstanceRateDivisor
                || !required.extVertexAttributeDivisor.vertexAttributeInstanceRateDivisor || REPORT(vertexAttributeInstanceRateDivisor))
        && (m_deviceFeatures.extVertexAttributeDivisor.vertexAttributeInstanceRateZeroDivisor
                || !required.extVertexAttributeDivisor.vertexAttributeInstanceRateZeroDivisor || REPORT(vertexAttributeInstanceRateZeroDivisor))
        && (m_deviceFeatures.khrTimelineSemaphore.timelineSemaphore
                || !required.khrTimelineSemaphore.timelineSemaphore || REPORT(timelineSemaphore));
#undef REPORT
  }
